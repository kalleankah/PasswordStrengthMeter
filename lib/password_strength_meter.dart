...
class PasswordStrengthMeter extends StatelessWidget {
  ...
  late final List<String> commonPasswords;
...
class CrackingMachine {
  ...
  /// [hashRate] specifies the speed at which the machine can test password combinations.
...
class CrackingCase {
  ...
  /// [factor] is used to divide the number of possible combinations.
